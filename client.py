...
class GUI:
    ...
    def layout(self,name):
        ...
        self.textCons= Text(self.Window, width=20, height=2, bg="#17202A", fg="#EAECEE",font="Helvetica 13 bold", pady=5, padx=5)
        ...
        self.entryMsg.focus()
        self.buttonMsg= Button(self.labelBottom, text="SEND", font="Helvetica 10 bold", width=20, bg="#ABB2B9", compound=lambda:self.sendButton(self.entryMsg.get()))
